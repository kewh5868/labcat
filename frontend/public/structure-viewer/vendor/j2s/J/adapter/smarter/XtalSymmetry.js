...
var assemblyIdAtoms = thisBiomolecule.get("assemblyIdAtoms");
if (filter.indexOf("#<") >= 0) {
...
bsAtoms =  new JU.BS();
for (var e, $e = assemblyIdAtoms.entrySet().iterator (); $e.hasNext()&& ((e = $e.next ()) || true);) {
...
;//5.0.1-v7 Wed Aug 26 16:43:26 CDT 2026
